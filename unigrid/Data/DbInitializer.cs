...
namespace unigrid.Data
{
    public static class DbInitializer
    {
        public static async System.Threading.Tasks.Task InitializeAndSeedAsync(UniGridDbContext context, ILogger logger, bool forcePurge = false)
        {
            ...
            // Ensure the traffic aggregate exists for databases created before
            // WebsiteTraffic was added. EnsureCreated does not add new tables to
            ...
            await context.Database.ExecuteSqlRawAsync("""
                CREATE TABLE IF NOT EXISTS "WebsiteTraffic" (
                    ...
                    CONSTRAINT "PK_WebsiteTraffic" PRIMARY KEY ("TrafficDate", "Path")
                );
                """);

            await context.Database.ExecuteSqlRawAsync("""
                CREATE TABLE IF NOT EXISTS "MonthlyProjectCosts" (
                    "Id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                    "CostMonth" date NOT NULL,
                ...
                CREATE INDEX IF NOT EXISTS "IX_MonthlyProjectCosts_CostMonth"
                    ON "MonthlyProjectCosts" ("CostMonth");
                """);
