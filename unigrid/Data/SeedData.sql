...
('99999999-9999-9999-9999-999999999999', 'business_monthly', 'Active', DATEADD(day, 15, GETUTCDATE()), 899000.00, 'AAAAAA11-1111-1111-1111-111111111111', 'Credit Card', 'TXN-WS-SE-PRO', DATEADD(day, -15, GETUTCDATE()), 0),
('88888888-8888-8888-8888-888888888888', 'proplus_monthly', 'Active', DATEADD(day, 20, GETUTCDATE()), 449000.00, 'AAAAAA11-1111-1111-1111-111111111111', 'Credit Card', 'TXN-WS-WEB-DEV', DATEADD(day, -10, GETUTCDATE()), 0),
('77777777-7777-7777-7777-777777777777', 'personal_monthly', 'Active', DATEADD(day, 25, GETUTCDATE()), 40000.00, 'BBBBBB22-2222-2222-2222-222222222222', 'Credit Card', 'TXN-WS-MATH-101', DATEADD(day, -5, GETUTCDATE()), 0),
('66666666-6666-6666-6666-666666666666', 'free_monthly', 'Active', DATEADD(year, 10, GETUTCDATE()), 0.00, NULL, 'System', 'TXN-WS-PHYS-101', DATEADD(month, -1, GETUTCDATE()), 0),
('55555555-5555-5555-5555-555555555555', 'free_monthly', 'Active', DATEADD(year, 10, GETUTCDATE()), 0.00, NULL, 'System', 'TXN-WS-ENGL-101', DATEADD(month, -1, GETUTCDATE()), 0),
('44444444-4444-4444-4444-444444444444', 'free_monthly', 'Active', DATEADD(year, 10, GETUTCDATE()), 0.00, NULL, 'System', 'TXN-WS-RES-101', DATEADD(month, -1, GETUTCDATE()), 0),
('33333333-2222-1111-0000-999999999999', 'proplus_monthly', 'Active', DATEADD(day, 22, GETUTCDATE()), 449000.00, 'BBBBBB22-2222-2222-2222-222222222222', 'Credit Card', 'TXN-WS-DSN-FLOW', DATEADD(day, -8, GETUTCDATE()), 0),
('22222222-1111-0000-9999-888888888888', 'pro_monthly', 'Active', DATEADD(day, 18, GETUTCDATE()), 299000.00, 'CCCCCC33-3333-3333-3333-333333333333', 'Credit Card', 'TXN-WS-MBL-APP', DATEADD(day, -12, GETUTCDATE()), 0),
('11111111-0000-9999-8888-777777777777', 'business_monthly', 'Active', DATEADD(day, 24, GETUTCDATE()), 899000.00, 'FFFFFF66-6666-6666-6666-666666666666', 'Credit Card', 'TXN-WS-GLB-OPS', DATEADD(day, -6, GETUTCDATE()), 0),
('aaaaaaaa-1111-2222-3333-444444444444', 'proplus_monthly', 'Active', DATEADD(day, 26, GETUTCDATE()), 449000.00, 'AAAAAA11-1111-1111-1111-111111111111', 'Credit Card', 'TXN-WS-AI-LAB', DATEADD(day, -4, GETUTCDATE()), 0),
('bbbbbbbb-2222-3333-4444-555555555555', 'pro_monthly', 'Active', DATEADD(day, 28, GETUTCDATE()), 299000.00, 'BBBBBB22-2222-2222-2222-222222222222', 'Credit Card', 'TXN-WS-DATA-HUB', DATEADD(day, -2, GETUTCDATE()), 0),
('addf9518-a3ba-42e5-9ea9-63073077c592', 'personal_monthly', 'Active', DATEADD(day, 15, GETUTCDATE()), 40000.00, 'AAAAAA33-3333-3333-3333-333333333333', 'Credit Card', 'TXN-WS-PRJ-1200', DATEADD(day, -15, GETUTCDATE()), 0),
('245141b6-95c1-4d3e-8fe1-dd96bef76323', 'pro_monthly', 'Active', DATEADD(day, 18, GETUTCDATE()), 299000.00, '0568ad89-cc72-4cb7-8b47-b714a14ad305', 'Credit Card', 'TXN-WS-PRJ-1300', DATEADD(day, -12, GETUTCDATE()), 0),
('50a64fa8-6902-4848-b949-f831c89da00c', 'proplus_monthly', 'Active', DATEADD(day, 20, GETUTCDATE()), 449000.00, 'a14c900d-d26d-4f5d-bc2e-a3da6ca8288b', 'Credit Card', 'TXN-WS-PRJ-1400', DATEADD(day, -10, GETUTCDATE()), 0),
('ee32234d-40a4-4080-8ffa-49fdef310a7b', 'pro_monthly', 'Active', DATEADD(day, 18, GETUTCDATE()), 299000.00, '938db8ea-47c1-4658-9da8-683d1781035d', 'Credit Card', 'TXN-WS-PRJ-1500', DATEADD(day, -12, GETUTCDATE()), 0),
('aaedaea8-bcb9-436e-a713-60b736cfb35a', 'personal_monthly', 'Active', DATEADD(day, 15, GETUTCDATE()), 40000.00, '0391258e-5399-4f33-a857-86430cd399e3', 'Credit Card', 'TXN-WS-PRJ-1600', DATEADD(day, -15, GETUTCDATE()), 0);
...
-- SE Messages (RoomId: '31d1b48a-e75b-41ad-affc-6551f4164b04')
('31d1b48a-e75b-41ad-affc-6551f4164b04', 'BBBBBB22-2222-2222-2222-222222222222', N'CI/CD pipeline is ready! GitHub actions will trigger on every PR now.', DATEADD(hour, -12, GETUTCDATE()), 0, 0),
('31d1b48a-e75b-41ad-affc-6551f4164b04', 'EEEEEE55-5555-5555-5555-555555555555', N'Can you guys give me access to the staging link? Need to test UI views.', DATEADD(hour, -10, GETUTCDATE()), 0, 0),
('31d1b48a-e75b-41ad-affc-6551f4164b04', 'AAAAAA11-1111-1111-1111-111111111111', N'Yes Eve, here it is: https://unigrid-staging.azurewebsites.net', DATEADD(hour, -8, GETUTCDATE()), 0, 0),
('31d1b48a-e75b-41ad-affc-6551f4164b04', 'EEEEEE55-5555-5555-5555-555555555555', N'Got it! Thank you Alice.', DATEADD(hour, -7, GETUTCDATE()), 0, 0),
('31d1b48a-e75b-41ad-affc-6551f4164b04', 'FFFFFF66-6666-6666-6666-666666666666', N'Has anyone optimized the index queries on the AuditLog tables? They are getting a bit slow.', DATEADD(hour, -5, GETUTCDATE()), 0, 0),
('31d1b48a-e75b-41ad-affc-6551f4164b04', 'BBBBBB22-2222-2222-2222-222222222222', N'I did! Created composite indexes on WorkspaceId and Timestamp. Speed is 10x now.', DATEADD(hour, -4, GETUTCDATE()), 0, 0),
('31d1b48a-e75b-41ad-affc-6551f4164b04', 'EEEEEE11-1111-1111-1111-111111111111', N'Refactoring is looking awesome! Added the UI style guide to files.', DATEADD(hour, -3, GETUTCDATE()), 0, 0),
('31d1b48a-e75b-41ad-affc-6551f4164b04', 'FFFFFF22-2222-2222-2222-222222222222', N'Just upgraded the cluster Helm charts. Deploying to secondary staging now.', DATEADD(hour, -2, GETUTCDATE()), 0, 0),
('31d1b48a-e75b-41ad-affc-6551f4164b04', 'AAAAAA33-3333-3333-3333-333333333333', N'Checked database sync metrics. Replica lag is below 5ms!', DATEADD(hour, -1, GETUTCDATE()), 0, 0),
('31d1b48a-e75b-41ad-affc-6551f4164b04', 'AAAAAA11-1111-1111-1111-111111111111', N'Excellent team effort. Let''s do a quick sync up session this week!', DATEADD(minute, -30, GETUTCDATE()), 0, 0),

-- Web Messages (RoomId: '664f1c2a-cbbc-45b6-b689-113b39207e96')
('664f1c2a-cbbc-45b6-b689-113b39207e96', 'AAAAAA11-1111-1111-1111-111111111111', N'Welcome to the E-Commerce Branch channel! Stripe integration is our top priority.', DATEADD(hour, -10, GETUTCDATE()), 0, 0),
('664f1c2a-cbbc-45b6-b689-113b39207e96', 'CCCCCC33-3333-3333-3333-333333333333', N'I am structuring the product page schemas. Standard JSON-LD is ready.', DATEADD(hour, -8, GETUTCDATE()), 0, 0),
('664f1c2a-cbbc-45b6-b689-113b39207e96', 'BBBBBB22-2222-2222-2222-222222222222', N'Product catalog queries are cached using Redis. Page speeds are below 200ms.', DATEADD(hour, -6, GETUTCDATE()), 0, 0),
('664f1c2a-cbbc-45b6-b689-113b39207e96', 'BBBBBB88-8888-8888-8888-888888888888', N'Refactored Cart view to standard React functional hooks. Check out the latest commit.', DATEADD(hour, -3, GETUTCDATE()), 0, 0),
('664f1c2a-cbbc-45b6-b689-113b39207e96', 'EEEEEE11-1111-1111-1111-111111111111', N'Just polished payment buttons with subtle hover interactions.', DATEADD(hour, -2, GETUTCDATE()), 0, 0),
('664f1c2a-cbbc-45b6-b689-113b39207e96', 'AAAAAA11-1111-1111-1111-111111111111', N'Superb! I will run local testing on Cart payment steps today.', DATEADD(hour, -1, GETUTCDATE()), 0, 0),

-- AI Lab Messages (RoomId: 'fed54321-1234-1234-1234-123456789012')
('fed54321-1234-1234-1234-123456789012', 'AAAAAA11-1111-1111-1111-111111111111', N'Starting active multi-node training loop for our custom LLM!', DATEADD(hour, -8, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'BBBBBB22-2222-2222-2222-222222222222', N'InfiniBand is holding up well, no dropped packets reported.', DATEADD(hour, -6, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'EEEEEE11-1111-1111-1111-111111111111', N'Instruction dataset is pristine. Trimmed 50k duplicates yesterday.', DATEADD(hour, -4, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'FFFFFF22-2222-2222-2222-222222222222', N'Checked checkpoints folder, autosave is working seamlessly.', DATEADD(hour, -2, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'AAAAAA11-1111-1111-1111-111111111111', N'Amazing. Let''s monitor convergence metrics through the weekend.', DATEADD(hour, -1, GETUTCDATE()), 0, 0),

-- AI Lab - ai-models Channel
('fed54321-1234-1234-1234-123456789012', 'AAAAAA11-1111-1111-1111-111111111111', N'[channel:ai-models]Let''''s discuss our model architecture. I''''m thinking of starting with a hybrid decoder-only transformer.', DATEADD(hour, -24, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'EEEEEE11-1111-1111-1111-111111111111', N'[channel:ai-models]Should we use RoPE for positional embeddings? It seems to perform better at longer context windows.', DATEADD(hour, -23, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'AAAAAA11-1111-1111-1111-111111111111', N'[channel:ai-models]Yes, RoPE is a must. Let''''s target an 8k context length initially.', DATEADD(hour, -22, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'BBBBBB22-2222-2222-2222-222222222222', N'[channel:ai-models]We''''ll need to optimize the attention kernel. FlashAttention-2 is integrated into our training stack, so we''''re good to go.', DATEADD(hour, -21, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'FFFFFF22-2222-2222-2222-222222222222', N'[channel:ai-models]I''''ve updated the model config file in the repository. Let me know if you want to tweak any hyperparameters.', DATEADD(hour, -20, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'AAAAAA11-1111-1111-1111-111111111111', N'[channel:ai-models]Great. I''''ll launch a small 1B param test run tonight to check loss convergence.', DATEADD(hour, -19, GETUTCDATE()), 0, 0),

-- AI Lab - infrastructure Channel
('fed54321-1234-1234-1234-123456789012', 'BBBBBB22-2222-2222-2222-222222222222', N'[channel:infrastructure]H100 node cluster scaling is complete. We now have 8 nodes online (64 GPUs total).', DATEADD(hour, -15, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'FFFFFF22-2222-2222-2222-222222222222', N'[channel:infrastructure]I''''m seeing some thermal throttling on node-04 during full load. Can we check the cooling allocation?', DATEADD(hour, -14, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'BBBBBB22-2222-2222-2222-222222222222', N'[channel:infrastructure]On it. I''''ll talk to the datacenter team. In the meantime, I set a temporary power limit of 350W on node-04 GPUs.', DATEADD(hour, -13, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'AAAAAA11-1111-1111-1111-111111111111', N'[channel:infrastructure]Thanks Bob. Keep me posted. We need the full cluster at 100% capacity for the 70B parameter run next week.', DATEADD(hour, -12, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'BBBBBB22-2222-2222-2222-222222222222', N'[channel:infrastructure]Good news, the datacenter team verified the airflow blockage. Node-04 is running at normal temperatures now. Power limits restored.', DATEADD(hour, -10, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'FFFFFF22-2222-2222-2222-222222222222', N'[channel:infrastructure]Confirmed. Benchmarks show full throughput without throttling. Cluster is green.', DATEADD(hour, -9, GETUTCDATE()), 0, 0),

-- AI Lab - dataset-ops Channel
('fed54321-1234-1234-1234-123456789012', 'EEEEEE11-1111-1111-1111-111111111111', N'[channel:dataset-ops]The WebText-filtered dataset is clean. We pruned around 12% of duplicate/low-quality documents.', DATEADD(hour, -18, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'FFFFFF22-2222-2222-2222-222222222222', N'[channel:dataset-ops]Nice work Liam. Did you filter out toxic content and PII?', DATEADD(hour, -17, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'EEEEEE11-1111-1111-1111-111111111111', N'[channel:dataset-ops]Yes, ran our default regex filters for PII and used a lightweight classifier for hate speech/NSFW content.', DATEADD(hour, -16, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'AAAAAA11-1111-1111-1111-111111111111', N'[channel:dataset-ops]Perfect. What''''s the final token count for this subset?', DATEADD(hour, -15, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'EEEEEE11-1111-1111-1111-111111111111', N'[channel:dataset-ops]About 450 billion tokens. Combined with the code and math datasets, we''''re looking at a total of 1.2 trillion tokens.', DATEADD(hour, -14, GETUTCDATE()), 0, 0),
('fed54321-1234-1234-1234-123456789012', 'BBBBBB22-2222-2222-2222-222222222222', N'[channel:dataset-ops]Awesome. I''''ll start pre-staging the data onto the local NVMe cache drives on each GPU node to minimize training latency.', DATEADD(hour, -12, GETUTCDATE()), 0, 0);
...
('Plans', '[
  { 
    ...
    "ColorClass": "teal",
    "Features": [ "1 Workspace", "1 Member", "2 GB Storage (Individual)", "0 Chat Channels", "1 Task Branch", "Basic Analytics" ],
    "MemberLimit": 1,
...
-- Seed SettingsJson channels for AI R&D Lab
UPDATE Workspaces 
SET SettingsJson = '{"lockedChannels":{"infrastructure":["aaaaaa11-1111-1111-1111-111111111111","bbbbbb22-2222-2222-2222-222222222222","ffffff22-2222-2222-2222-222222222222"]},"channelOwners":{"ai-models":"aaaaaa11-1111-1111-1111-111111111111","infrastructure":"bbbbbb22-2222-2222-2222-222222222222","dataset-ops":"eeeeee11-1111-1111-1111-111111111111"},"channelModerators":{"ai-models":[],"infrastructure":[],"dataset-ops":[]},"allChannels":["general","ai-models","infrastructure","dataset-ops"],"disabledCreateChannelUsers":[],"disabledCreateTaskUsers":[],"disabledEditTaskUsers":[],"disabledDeleteFileUsers":[],"disabledDeleteTaskUsers":[]}'
